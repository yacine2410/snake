...
# choose difficulty 1 to 3: Easy, Medium, Hard
# Easy: Slow, Just Apples
# Medium: Medium Speed, Mines + Apples 
# Hard: Fast, Mines & Apples in tougher places
# Diffculty: {1, 2, 3}
...
def play_time():
    global change_to, direction, window_x, window_y, snake_body, snake_position, snake_speed, fruit_position, fruit_spawn, score
    while True:
        # handling key events
